...
前端栈决策（待评审）：[ADR-0008：前端改用 React + Semi Design](architecture/decisions/0008-frontend-react-semi-migration.md)，W11-D 新页面按该决策在 React + Semi 上开发。
