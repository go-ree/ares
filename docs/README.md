...
W11-A1 开发入口：[CI/CD 模板结构契约与校验 API](development/pipeline-template-contract.md)（仅结构校验，模板保存和执行尚未接入）。
...
- 运维文档：[部署指南](operations/deployment.md)、[数据库迁移与恢复手册](operations/database-migrations.md)
