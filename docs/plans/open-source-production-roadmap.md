...
> - 文档类型：持续更新的开发路线与进度看板
> - 当前状态：W11-A3 管理 API 本次交付，待验收；B～F 未开始，W07-C 暂缓
> - 基线版本：`main@9d51956`，已合并 [PR #58](https://github.com/go-ree/ares/pull/58)
> - 最后更新：2026-09-14

## 2026-09-14：W11-A3 类型与模板管理 API
...
| W11    | 应用类型 CI、产出物与独立 CD | W02～W06、W07-A/B；真实接入另需 W07-C/W08 | `开发中` | [PR #59](https://github.com/go-ree/ares/pull/59) | A1/A2 已合并；A3 待验收 |
...
PR #40/#41/#42/#43/#44/#51/#53/#57/#58 已合并。本次交付 W11-A3 管理接口、权限和审计；下一增量 W11-B 固定版本绑定与独立运行。W07-C 暂缓至新模型稳定；W01 管理项继续独立跟踪。A3 尚待验收，构建部署能力未完成。
