...
| W07    | 重试、取消、超时与尝试历史   | W03、W06           | `开发中` | A：[PR #37](https://github.com/go-ree/ares/pull/37) | A 已完成；B 待验收；C 未开始                  |
...
| W07-B | 策略、attempt 迁移、有限自动/手动重试、尝试历史 | 待验收，PR 待创建 |
...
- 范围：W07-B 待验收；W07-C 持久化取消与执行器确认协议未开始，因此 W07 整体仍为开发中。云端检查以新 PR 实时状态为准。
