<template>
  <div class="log-content">
    <div class="section-title">
      ...
      <span>历史发布记录</span>
      <el-button type="primary" link :loading="logLoading" @click="handleSearch">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="操作" width="100" fixed="right">
          <template #default="{ row }">
            <el-button type="primary" link @click="handleViewLogDetail(row)"> 查看日志 </el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
